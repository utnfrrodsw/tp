...
const crearHabitacionLocalidad = async (req, res) => {
  const { nroHabitacion, idProvincia } = req.body;
  try {
    const nuevaRelacion = new HabitacionLocalidad({ nroHabitacion, idProvincia });
...
const actualizarHabitacionLocalidad = async (req, res) => {
  ...
  const { nroHabitacion, idProvincia } = req.body;
  try {
    const nuevaRelacion = { nroHabitacion, idProvincia };
