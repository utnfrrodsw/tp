...
app.post('/api/usuarios', sanitizeUsuarioInput, (req, res) => {
    ...
    const usuario = new Usuario(input.id, input.email, input.contrasena, input.tipoDoc, input.numDoc, input.direccion, input.telefono, input.nombre, input.apellido, input.fechaNacimiento, input.nombreFantasia, input.foto);
