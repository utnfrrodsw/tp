...
async function add(req: Request, res: Response) {
    try {
        ...
        const pedidoInput = new Pedido(
            ...
            usuarioId,
            libroIds,
            input.estado || "Pendiente" // Usa el estado proporcionado o "Pendiente" por defecto
        );
    ...
    try {
        ...
        if (!pedidoExiste) {
            ...
            const pedidoInput = new Pedido(
                ...
                updatedData.usuario,
                updatedData.libro,
                updatedData.estado || "Pendiente", // Usa el estado proporcionado o "Pendiente" por defecto
                objectIdPedidoId
            );
...
async function findByEstado(req: Request, res: Response) {
    try {
