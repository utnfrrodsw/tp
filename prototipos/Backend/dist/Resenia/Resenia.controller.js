...
async function add(req, res) {
    try {
        ...
        const reseniaInput = new Resenia(input.comentario, input.calificacion, new ObjectId(input.usuario), new ObjectId(input.libro));
...
async function update(req, res) {
    try {
        ...
        if (!reseniaExiste) {
            ...
            const reseniaInput = new Resenia(updatedData.comentario, updatedData.calificacion, updatedData.usuario, updatedData.libro, objectIdReseniaId);
...
async function getResenias(req, res) {
    try {
...
//# sourceMappingURL=Resenia.controller.js.map