...
constructor(private tiposVolqueteService: TiposVolqueteService,
...
private fetchProveedores() {
  this.tiposVolqueteService.getAll().subscribe((data: TipoVolqueteModel[]) => {
    this.tipos = data;
  });
}
