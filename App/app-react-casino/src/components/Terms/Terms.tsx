...
export function Terms() {
    ...
    return(
        ...
        <p> Last Updated: 08/09/2024 </p>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Acceptance of Terms </h2>
            <p> By registering and using UTimbaN, you agree to be legally responsible for complying with these terms and conditions.</p>
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Age Requirements </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> User Registration </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Payment Information </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Jurisdiction </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Changes to Terms </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Contact </h2>
            <p> If you have any questions regarding these terms, you may contact us at [contact email] or [contact phone number]. </p>
            <h2 className="text-2xl md:text-3xl font-bold pt-2"> Acceptance of Risk </h2>
