  ...
  return(
    <>
      ...
      <div className='block md:hidden bg-red-500'>
        <p className='pb-3 text-sm text-center'> GAMBLE WITH RESPONSABILITY </p>
        <p className='pt-3 text-sm text-center'> <strong> 1-800-GAMBLER </strong></p>
      </div>

      <div className="p-4 md:flex-nowrap md:flex gap-0 md:flex-row">
        <div className="flex flex-grow flex-col md:grid md:grid-cols-2">
          <div className="mb-1">
            <div className=" flex mb-2 text-lg font-bold text-yellow-500"> <p> Policies </p></div>
            <div className=' m-0 gap-2 flex flex-col text-white ' > 
              <div className=' hover:text-yellow-500'> <Link to='/terms'> Terms And Conditions </Link> </div>
              <div className=' hover:text-yellow-500'> <Link to='/privacypolicy'> Privacy Policy </Link> </div>
              <div className=' hover:text-yellow-500'> <Link to='/promotions'> Bonus and Promotions </Link> </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-grow flex-col md:grid md:grid-cols-2">
          <div className="mb-1">
            <div className=" flex mb-2 text-lg font-bold text-yellow-500"> <p> Support </p></div>
            <div className=' m-0 gap-2 flex flex-col text-white ' > 
              <Link to='/aboutus' className=' hover:text-yellow-500'> About Us </Link> 
              <div className=' hover:text-yellow-500'> <Link to='/help'> Help Center </Link> </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2">
          <div className="mb-1">
            <div className=" flex mb-2 text-lg font-bold text-yellow-500"> <p> Community </p></div>
            <div className='gap-6 flex md:grid md:grid-rows-2 md:grid-cols-2' > 
              <a href='https://www.twitter.com/starboyagus' className=' fill-white hover:fill-yellow-500' target='_blank' >      
              ...
              <a href='https://www.instagram.com/niciade_/' className=' fill-white hover:fill-yellow-500' target='_blank' >      
              ...
              <a href='https://www.instagram.com/lucasmaggi03/' className=' fill-white hover:fill-yellow-500' target='_blank' >      
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" ><path d="M16.98 0a6.9 6.9 0 0 1 5.08 1.98A6.94 6.94 0 0 1 24 7.02v9.96c0 2.08-.68 3.87-1.98 5.13A7.14 7.14 0 0 1 16.94 24H7.06a7.06 7.06 0 0 1-5.03-1.89A6.96 6.96 0 0 1 0 16.94V7.02C0 2.8 2.8 0 7.02 0h9.96zm.05 2.23H7.06c-1.45 0-2.7.43-3.53 1.25a4.82 4.82 0 0 0-1.3 3.54v9.92c0 1.5.43 2.7 1.3 3.58a5 5 0 0 0 3.53 1.25h9.88a5 5 0 0 0 3.53-1.25 4.73 4.73 0 0 0 1.4-3.54V7.02a5 5 0 0 0-1.3-3.49 4.82 4.82 0 0 0-3.54-1.3zM12 5.76c3.39 0 6.2 2.8 6.2 6.2a6.2 6.2 0 0 1-12.4 0 6.2 6.2 0 0 1 6.2-6.2zm0 2.22a3.99 3.99 0 0 0-3.97 3.97A3.99 3.99 0 0 0 12 15.92a3.99 3.99 0 0 0 3.97-3.97A3.99 3.99 0 0 0 12 7.98zm6.44-3.77a1.4 1.4 0 1 1 0 2.8 1.4 1.4 0 0 1 0-2.8z"/></svg>              
              </a>
              <a href='https://www.instagram.com/_maw911/' className=' fill-white hover:fill-yellow-500' target='_blank' >      
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" ><path d="M16.98 0a6.9 6.9 0 0 1 5.08 1.98A6.94 6.94 0 0 1 24 7.02v9.96c0 2.08-.68 3.87-1.98 5.13A7.14 7.14 0 0 1 16.94 24H7.06a7.06 7.06 0 0 1-5.03-1.89A6.96 6.96 0 0 1 0 16.94V7.02C0 2.8 2.8 0 7.02 0h9.96zm.05 2.23H7.06c-1.45 0-2.7.43-3.53 1.25a4.82 4.82 0 0 0-1.3 3.54v9.92c0 1.5.43 2.7 1.3 3.58a5 5 0 0 0 3.53 1.25h9.88a5 5 0 0 0 3.53-1.25 4.73 4.73 0 0 0 1.4-3.54V7.02a5 5 0 0 0-1.3-3.49 4.82 4.82 0 0 0-3.54-1.3zM12 5.76c3.39 0 6.2 2.8 6.2 6.2a6.2 6.2 0 0 1-12.4 0 6.2 6.2 0 0 1 6.2-6.2zm0 2.22a3.99 3.99 0 0 0-3.97 3.97A3.99 3.99 0 0 0 12 15.92a3.99 3.99 0 0 0 3.97-3.97A3.99 3.99 0 0 0 12 7.98zm6.44-3.77a1.4 1.4 0 1 1 0 2.8 1.4 1.4 0 0 1 0-2.8z"/></svg>
              </a>
            </div>
          </div>
