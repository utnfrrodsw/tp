...
export function AboutUs() {
    ...
    return(
        ...
        <h1 className="au-title"> About UTimbaN </h1>
            ...
            <h2 className="sub-title pb-2 "> Our Mission </h2>
            ...
            <h2 className="sub-title md:text-3xl font-bold py-2 "> Games and Promotions </h2>
            ...
            <h2 className="sub-title md:text-3xl font-bold py-2 "> Commitment with security </h2>
            ...
            <h2 className="sub-title md:text-3xl font-bold py-2 "> Join the UTimbaN experience </h2>
