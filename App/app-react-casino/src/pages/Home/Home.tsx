        ...
        <div>
            ...
            <section className='px-20 max-sm:px-3'>
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-4 pb-20 rounded-xl max-sm:gap-2 text-center'>
                    ...
                    <Link to="" className='max-md:col-span-2 md:col-span-2 lg:col-span-2 bg-[#808080] border-2 border-[#e19400] h-[175px rounded-[20px] bg-[url("./src/assets/images/games-roulette-gray.png")] bg-center bg-cover text-[#D81536] text-7xl font-bold flex justify-center items-center'>COMING SOON</Link>
