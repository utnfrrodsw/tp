        ...
        <div>
            ...
            <section className='px-20 max-sm:px-3'>
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-4 pb-20 rounded-xl max-sm:gap-2 text-center'>
                    ...
                    <Link to="" className='col-span-2 lg:col-span-2 bg-white border-2 border-[#e19400] h-[175px] text-white rounded-[20px] bg-[url("./src/assets/images/games-roulette.png")] bg-center bg-cover bg-contain transition ease-in-out'> </Link>
                    <Link to="" className='col-span-2 lg:col-span-1 h-[175px] border-1 rounded-[20px]'> </Link>
                    <Link to="" className='col-span-2 lg:col-span-1 h-[175px] border-1 rounded-[20px]'> </Link>
